...
torchrun --nproc_per_node 1 quant.py --eval --resume checkpoints/vim_s_midclstok_80p5acc.pth --model vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2 --data-path /lichenghao/cgh/datasets/imagenet --act_scales ./smoothing_s.pt --batch-size 256 --qmode ptq4vm --train-batch 256 --n-lva 256 --n-lvw 256 --alpha 0.5 --epochs 100 --lr-a 5e-4 --lr-w 5e-4 --lr-s 1e-2
